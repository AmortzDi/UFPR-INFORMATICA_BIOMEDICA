...
void teste_insere_ordenado(struct lista *l) {
    lista_insere_ordenado(l, 13);
    imprimir_lista(l);
    lista_insere_ordenado(l, 15);
    imprimir_lista(l);
    lista_insere_ordenado(l, 11);
    imprimir_lista(l);
    lista_insere_ordenado(l, 12);
    imprimir_lista(l);
    lista_insere_ordenado(l, 14);
    imprimir_lista(l);
}

void teste_remove_ordenado(struct lista *l) {
    lista_remove_ordenado(l, 13);
    imprimir_lista(l);
    lista_remove_ordenado(l, 15);
    imprimir_lista(l);
    lista_remove_ordenado(l, 11);
    imprimir_lista(l);
    lista_remove_ordenado(l, 12);
    imprimir_lista(l);
    lista_remove_ordenado(l, 14);
    imprimir_lista(l);
}
