...
// Devolve o número de elementos na lista l
int tamanho_lista(lista l) {
    int contador = 0;
    
    // Verifica se a lista é nula para evitar erros
    if (!l) {
        return 0;
    }

    // Percorre a lista do primeiro ao último nó
    for (no n = primeiro_no(l); n != NULL; n = proximo(n)) {
